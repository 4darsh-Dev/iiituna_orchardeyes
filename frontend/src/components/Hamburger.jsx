...
import { Menu, X, Globe, HelpCircle, Info, LogOut, Settings, Monitor, Leaf, Trophy, Video, User2 } from 'lucide-react';
            ...
            <nav className={`fixed top-0 left-0 h-full w-64 bg-white shadow-lg transform transition-transform duration-300 ease-in-out ${
                ...
                <div className="flex flex-col h-full">
                    ...
                    {/* Menu Items */}
                                        ...
                                        <div className="py-2 ">
                                                <button
                                                    onClick={() => {handleItemClick('about'); handleNavigation("/about");}}
                                                ...
                                                <button
                                                    onClick={() => {handleItemClick('profile'); handleNavigation("/profile");}}
                                                    className="w-full px-4 py-2 flex items-center gap-3 hover:bg-gray-100 text-black mb-[1.5rem] mt-[1.5rem]"
                                                >
                                                    <User2 size={20} />
                                                    <span>Profile</span>
